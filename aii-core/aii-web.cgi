...
# CGI script to control install/boot of nodes using AII.
# Based on install.cgi script from LCFG (author unknown)
# Modified for AII by Stephen Childs (childss@cs.tcd.ie) 2007/8
